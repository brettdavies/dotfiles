...
Follow the Conventional Commits specification. This file contains agent workflow instructions followed by the specification reference.
...
2. **Apply Single Responsibility Principle** - Each commit should do one thing. If changes can be logically separated, propose multiple commits:
...
3. **Propose partial staging when appropriate** - If a file contains unrelated changes:
...
4. **Format for multiple commits** - When proposing separate commits, use this format:
